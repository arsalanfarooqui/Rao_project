function createjobdetail(job) {
    ...
    <div id="message3"></div>
    <h1 style="text-align: center; font-family: Arial, Helvetica, sans-serif;">Job Detail</h1>
    <div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="job-detail border rounded p-4">
                <div class="job-detail-content">
                    ...
                    <div class="job-detail-com-desc overflow-hidden d-block">
                        ...
                        <p class="text-muted mb-0"><i class="mdi mdi-link-variant mr-2"></i>${job.emailaddress}</p>
